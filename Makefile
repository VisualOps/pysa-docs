...
pandoc:
	pandoc -f markdown -t rst ./source/index.md > index.rst
...
qthelp:
	...
	@echo "# qcollectiongenerator $(BUILDDIR)/qthelp/t.qhcp"
	@echo "To view the help file:"
	@echo "# assistant -collectionFile $(BUILDDIR)/qthelp/t.qhc"
...
devhelp:
	...
	@echo "Build finished."
	@echo "To view the help file:"
	@echo "# mkdir -p $$HOME/.local/share/devhelp/t"
	@echo "# ln -s $(BUILDDIR)/devhelp $$HOME/.local/share/devhelp/t"
	@echo "# devhelp"
